...
import type { ExpressionPopupContext, ExpressionPopupSelectPayload } from "@repo/common"
...
const emit = defineEmits<{
  (e: "select", payload: ExpressionPopupSelectPayload): void
  (e: "close"): void
}>()
...
<template>
  <div class="popup-panel rounded-lg border bg-background p-2 shadow-xl" tabindex="0" @keydown="handleKeydown">
